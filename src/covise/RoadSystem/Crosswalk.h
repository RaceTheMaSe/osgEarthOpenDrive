...
{
    class Crosswalk : public Element
    {
    public:
        static const int DONOTENTER;
        static const int EXITERROR;

        Crosswalk(const std::string& id_,
                  const std::string& name_      = "unnamed-crosswalk",
                  const double       s_         = 0.0,
                  const double       length_    = 0.0,
                  const double       crossProb_ = 0.5,
                  const double       resetTime_ = 20.0,
                  const std::string& type_      = "crosswalk",
                  int                dbg_       = 0);
