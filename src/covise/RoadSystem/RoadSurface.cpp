...
crgSurface::crgSurface(const std::string &filename,
                       double             setSStart,
                       double             setSEnd,
                       SurfaceOrientation setOrient,
                       double             setSOff,
                       double             setTOff,
                       double             setZOff,
                       double             setZScale)
    : surface(filename),
    sStart(setSStart), sEnd(setSEnd), orientation(setOrient), sOffset(setSOff), tOffset(setTOff), zOffset(setZOff), zScale(setZScale),
    parallaxMap(NULL), pavementTextureImage(NULL)
{
}
