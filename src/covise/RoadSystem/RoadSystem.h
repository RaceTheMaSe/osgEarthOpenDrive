...
namespace vehicleUtil
{
    ...
    public:
        ...
        osg::ref_ptr<osg::Group>                                  roadSystemRoot = {};
        osg::ref_ptr<osg::Group>                                  initOsg(osg::Matrixd geoCentricMapOrigin);
        std::map<long long, osg::ref_ptr<osg::Vec3dArray>>        outlines;
        const std::map<long long, osg::ref_ptr<osg::Vec3dArray>>& initOsgOutlines();
