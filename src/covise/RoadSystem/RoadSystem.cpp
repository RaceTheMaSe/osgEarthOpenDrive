...
#include "convertMapCoordsWrapper.h"
// #include <proj_api.h>
...
void RoadSystem::parseOpenDrive(xercesc::DOMElement *rootElement)
{
    if (rootElement)
    {
        XMLCh *t1 = NULL, *t2 = NULL, *t3 = NULL, *t4 = NULL, *t5 = NULL, *t6 = NULL, *t7 = NULL, *t8 = NULL, *t9 = NULL, *t10 = NULL, *t11 = NULL,
              *t12 = NULL, *t13 = NULL, *t14 = NULL, *t15 = NULL, *t16 = NULL, *t17 = NULL, *t18 = NULL;
        char                                   *cs;
        Road                                   *road;
        ...
        for (unsigned int childIndex = 0; childIndex < documentChildrenList->getLength(); ++childIndex)
        {
            ...
            if (documentChildElement &&
                xercesc::XMLString::compareIString(documentChildElement->getTagName(), t1 = xercesc::XMLString::transcode("road")) == 0)
            {
                std::string roadIdString = cs =
                    xercesc::XMLString::transcode(documentChildElement->getAttribute(t2 = xercesc::XMLString::transcode("id")));
                xercesc::XMLString::release(&t2);
                xercesc::XMLString::release(&cs);
                ...
                std::string roadNameString = cs =
                    xercesc::XMLString::transcode(documentChildElement->getAttribute(t2 = xercesc::XMLString::transcode("name")));
                xercesc::XMLString::release(&t2);
                xercesc::XMLString::release(&cs);
                double roadLength =
                    atof(cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t2 = xercesc::XMLString::transcode("length"))));
                xercesc::XMLString::release(&t2);
                xercesc::XMLString::release(&cs);
                ...
                for (unsigned int childIndex = 0; childIndex < roadChildrenList->getLength(); ++childIndex)
                {
                    ...
                    else if (xercesc::XMLString::compareIString(roadChildElement->getTagName(), t2 = xercesc::XMLString::transcode("type")) == 0)
                    {
                        ...
                        typeStart =
                            atof(cs = xercesc::XMLString::transcode(roadChildElement->getAttribute(t12 = xercesc::XMLString::transcode("s"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        typeName = cs = xercesc::XMLString::transcode(roadChildElement->getAttribute(t12 = xercesc::XMLString::transcode("type")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                    ...
                    else if (xercesc::XMLString::compareIString(roadChildElement->getTagName(), t3 = xercesc::XMLString::transcode("speedlimit")) ==
                             0)
                    {
                        ...
                        xercesc::XMLString::release(&cs);
                        speedLimitNum =
                            atof(cs = xercesc::XMLString::transcode(roadChildElement->getAttribute(t12 = xercesc::XMLString::transcode("max"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                    ...
                    else if (xercesc::XMLString::compareIString(roadChildElement->getTagName(), t4 = xercesc::XMLString::transcode("planView")) == 0)
                    {
                        ...
                        for (unsigned int childIndex = 0; childIndex < planViewChildrenList->getLength(); ++childIndex)
                        {
                            ...
                            if (planViewChildElement && xercesc::XMLString::compareIString(planViewChildElement->getTagName(),
                                                                                           xercesc::XMLString::transcode("geometry")) == 0)
                            {
                                geometryStart = atof(
                                    cs = xercesc::XMLString::transcode(planViewChildElement->getAttribute(t12 = xercesc::XMLString::transcode("s"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                geometryX = atof(
                                    cs = xercesc::XMLString::transcode(planViewChildElement->getAttribute(t12 = xercesc::XMLString::transcode("x"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                geometryY = atof(
                                    cs = xercesc::XMLString::transcode(planViewChildElement->getAttribute(t12 = xercesc::XMLString::transcode("y"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                geometryHdg = atof(cs = xercesc::XMLString::transcode(
                                                       planViewChildElement->getAttribute(t12 = xercesc::XMLString::transcode("hdg"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                geometryLength = atof(cs = xercesc::XMLString::transcode(
                                                          planViewChildElement->getAttribute(t12 = xercesc::XMLString::transcode("length"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                ...
                                for (unsigned int curveIndex = 0; curveIndex < curveList->getLength(); ++curveIndex)
                                {
                                    ...
                                    if (!curveElement)
                                    {
                                        ...
                                        // std::cerr << "Content of node: " << xercesc::XMLString::transcode(curveElement->getTextContent()) <<
                                        // std::endl;
                                    }
                                    else if (xercesc::XMLString::compareIString(curveElement->getTagName(),
                                                                                t5 = xercesc::XMLString::transcode("line")) == 0)
                                    {
                                        ...
                                        road->addPlanViewGeometryLine(geometryStart, geometryLength, geometryX, geometryY, geometryHdg);
                                                                                ...
                                                                                t6 = xercesc::XMLString::transcode("spiral")) == 0)
                                    {
                                        double curveCurvStart = atof(cs = xercesc::XMLString::transcode(curveElement->getAttribute(
                                                                         t12 = xercesc::XMLString::transcode("curvStart"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        double curveCurvEnd = atof(cs = xercesc::XMLString::transcode(
                                                                       curveElement->getAttribute(t12 = xercesc::XMLString::transcode("curvEnd"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        road->addPlanViewGeometrySpiral(geometryStart,
                                                                        geometryLength,
                                                                        geometryX,
                                                                        geometryY,
                                                                        geometryHdg,
                                                                        ...
                                                                        curveCurvEnd);
                                                                                ...
                                                                                t7 = xercesc::XMLString::transcode("arc")) == 0)
                                    {
                                        double curveCurvature = atof(cs = xercesc::XMLString::transcode(curveElement->getAttribute(
                                                                         t12 = xercesc::XMLString::transcode("curvature"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        road->addPlanViewGeometryArc(geometryStart,
                                                                     geometryLength,
                                                                     geometryX,
                                                                     geometryY,
                                                                     geometryHdg,
                                                                     curveCurvature);
                                                                                ...
                                                                                t8 = xercesc::XMLString::transcode("poly3")) == 0)
                                    {
                                        double curveA = atof(
                                            cs = xercesc::XMLString::transcode(curveElement->getAttribute(t12 = xercesc::XMLString::transcode("a"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        double curveB = atof(
                                            cs = xercesc::XMLString::transcode(curveElement->getAttribute(t12 = xercesc::XMLString::transcode("b"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        double curveC = atof(
                                            cs = xercesc::XMLString::transcode(curveElement->getAttribute(t12 = xercesc::XMLString::transcode("c"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        double curveD = atof(
                                            cs = xercesc::XMLString::transcode(curveElement->getAttribute(t12 = xercesc::XMLString::transcode("d"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        road->addPlanViewGeometryPolynom(geometryStart,
                                                                         geometryLength,
                                                                         geometryX,
                                                                         geometryY,
                                                                         geometryHdg,
                                                                         ...
                                                                         curveD);
                                                                                ...
                                                                                t9 = xercesc::XMLString::transcode("paramPoly3")) == 0)
                                    {
                                        double curveAU = atof(cs = xercesc::XMLString::transcode(
                                                                  curveElement->getAttribute(t12 = xercesc::XMLString::transcode("aU"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        double curveBU = atof(cs = xercesc::XMLString::transcode(
                                                                  curveElement->getAttribute(t12 = xercesc::XMLString::transcode("bU"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        double curveCU = atof(cs = xercesc::XMLString::transcode(
                                                                  curveElement->getAttribute(t12 = xercesc::XMLString::transcode("cU"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        double curveDU = atof(cs = xercesc::XMLString::transcode(
                                                                  curveElement->getAttribute(t12 = xercesc::XMLString::transcode("dU"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        double curveAV = atof(cs = xercesc::XMLString::transcode(
                                                                  curveElement->getAttribute(t12 = xercesc::XMLString::transcode("aV"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        double curveBV = atof(cs = xercesc::XMLString::transcode(
                                                                  curveElement->getAttribute(t12 = xercesc::XMLString::transcode("bV"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        double curveCV = atof(cs = xercesc::XMLString::transcode(
                                                                  curveElement->getAttribute(t12 = xercesc::XMLString::transcode("cV"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        double curveDV = atof(cs = xercesc::XMLString::transcode(
                                                                  curveElement->getAttribute(t12 = xercesc::XMLString::transcode("dV"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        bool normalized = true;
                                        if (curveElement->getAttribute(xercesc::XMLString::transcode("pRange")))
                                        {
                                            std::string pRange = cs = xercesc::XMLString::transcode(
                                                curveElement->getAttribute(t12 = xercesc::XMLString::transcode("pRange")));
                                            xercesc::XMLString::release(&t12);
                                            xercesc::XMLString::release(&cs);
                                            if (pRange == "arcLength")
                                                normalized = false;
                    ...
                    else if (xercesc::XMLString::compareIString(roadChildElement->getTagName(),
                                                                t5 = xercesc::XMLString::transcode("elevationProfile")) == 0)
                    {
                        ...
                        for (unsigned int childIndex = 0; childIndex < elevationProfileChildrenList->getLength(); ++childIndex)
                        {
                            ...
                            if (elevationProfileChildElement &&
                                xercesc::XMLString::compareIString(elevationProfileChildElement->getTagName(),
                                                                   t6 = xercesc::XMLString::transcode("elevation")) == 0)
                            {
                                double elevationStart = atof(cs = xercesc::XMLString::transcode(elevationProfileChildElement->getAttribute(
                                                                 t12 = xercesc::XMLString::transcode("s"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double elevationA = atof(cs = xercesc::XMLString::transcode(
                                                             elevationProfileChildElement->getAttribute(t12 = xercesc::XMLString::transcode("a"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double elevationB = atof(cs = xercesc::XMLString::transcode(
                                                             elevationProfileChildElement->getAttribute(t12 = xercesc::XMLString::transcode("b"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double elevationC = atof(cs = xercesc::XMLString::transcode(
                                                             elevationProfileChildElement->getAttribute(t12 = xercesc::XMLString::transcode("c"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double elevationD = atof(cs = xercesc::XMLString::transcode(
                                                             elevationProfileChildElement->getAttribute(t12 = xercesc::XMLString::transcode("d"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                            ...
                            xercesc::XMLString::release(&t6);
                                                                ...
                                                                t6 = xercesc::XMLString::transcode("lateralProfile")) == 0)
                    {
                        ...
                        for (unsigned int childIndex = 0; childIndex < lateralProfileChildrenList->getLength(); ++childIndex)
                        {
                            ...
                            if (lateralProfileChildElement &&
                                xercesc::XMLString::compareIString(lateralProfileChildElement->getTagName(),
                                                                   t7 = xercesc::XMLString::transcode("superelevation")) == 0)
                            {
                                double superelevationStart = atof(cs = xercesc::XMLString::transcode(lateralProfileChildElement->getAttribute(
                                                                      t12 = xercesc::XMLString::transcode("s"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double superelevationA = atof(cs = xercesc::XMLString::transcode(lateralProfileChildElement->getAttribute(
                                                                  t12 = xercesc::XMLString::transcode("a"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double superelevationB = atof(cs = xercesc::XMLString::transcode(lateralProfileChildElement->getAttribute(
                                                                  t12 = xercesc::XMLString::transcode("b"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double superelevationC = atof(cs = xercesc::XMLString::transcode(lateralProfileChildElement->getAttribute(
                                                                  t12 = xercesc::XMLString::transcode("c"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double superelevationD = atof(cs = xercesc::XMLString::transcode(lateralProfileChildElement->getAttribute(
                                                                  t12 = xercesc::XMLString::transcode("d"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                road->addSuperelevationPolynom(superelevationStart,
                                                               superelevationA,
                                                               superelevationB,
                                                               superelevationC,
                                                               superelevationD);
                            }
                            else if (lateralProfileChildElement &&
                                     xercesc::XMLString::compareIString(lateralProfileChildElement->getTagName(),
                                                                        t8 = xercesc::XMLString::transcode("crossfall")) == 0)
                            {
                                double crossfallStart = atof(cs = xercesc::XMLString::transcode(
                                                                 lateralProfileChildElement->getAttribute(t12 = xercesc::XMLString::transcode("s"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double crossfallA = atof(cs = xercesc::XMLString::transcode(
                                                             lateralProfileChildElement->getAttribute(t12 = xercesc::XMLString::transcode("a"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double crossfallB = atof(cs = xercesc::XMLString::transcode(
                                                             lateralProfileChildElement->getAttribute(t12 = xercesc::XMLString::transcode("b"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double crossfallC = atof(cs = xercesc::XMLString::transcode(
                                                             lateralProfileChildElement->getAttribute(t12 = xercesc::XMLString::transcode("c"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double crossfallD = atof(cs = xercesc::XMLString::transcode(
                                                             lateralProfileChildElement->getAttribute(t12 = xercesc::XMLString::transcode("d"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                std::string crossfallSide(cs = xercesc::XMLString::transcode(
                                                              lateralProfileChildElement->getAttribute(t12 = xercesc::XMLString::transcode("side"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                road->addCrossfallPolynom(crossfallStart, crossfallA, crossfallB, crossfallC, crossfallD, crossfallSide);
                                     ...
                                     xercesc::XMLString::compareIString(lateralProfileChildElement->getTagName(),
                                                                        t9 = xercesc::XMLString::transcode("shape")) == 0)
                            {
                                double crossfallStart = atof(cs = xercesc::XMLString::transcode(
                                                                 lateralProfileChildElement->getAttribute(t12 = xercesc::XMLString::transcode("s"))));
                                xercesc::XMLString::release(&t12);
                                ...
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double crossfallT = atof(cs = xercesc::XMLString::transcode(
                                                             lateralProfileChildElement->getAttribute(t12 = xercesc::XMLString::transcode("t"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                    ...
                    else if (xercesc::XMLString::compareIString(roadChildElement->getTagName(), t7 = xercesc::XMLString::transcode("lanes")) == 0)
                    {
                        ...
                        for (unsigned int childIndex = 0; childIndex < lanesChildrenList->getLength(); ++childIndex)
                        {
                            ...
                            if (lanesChildElement && xercesc::XMLString::compareIString(lanesChildElement->getTagName(),
                                                                                        t8 = xercesc::XMLString::transcode("laneSection")) == 0)
                            {
                                double laneSectionStart = atof(
                                    cs = xercesc::XMLString::transcode(lanesChildElement->getAttribute(t12 = xercesc::XMLString::transcode("s"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                ...
                                for (unsigned int childIndex = 0; childIndex < laneSectionChildrenList->getLength(); ++childIndex)
                                {
                                    ...
                                    if (laneSectionChildElement &&
                                        (xercesc::XMLString::compareIString(laneSectionChildElement->getTagName(),
                                                                            t9 = xercesc::XMLString::transcode("left")) == 0 ||
                                         xercesc::XMLString::compareIString(laneSectionChildElement->getTagName(),
                                                                            t10 = xercesc::XMLString::transcode("center")) == 0 ||
                                         xercesc::XMLString::compareIString(laneSectionChildElement->getTagName(),
                                                                            t11 = xercesc::XMLString::transcode("right")) == 0))
                                    {
                                        ...
                                        for (unsigned int childIndex = 0; childIndex < laneList->getLength(); ++childIndex)
                                        {
                                            ...
                                            if (laneElement && xercesc::XMLString::compareIString(laneElement->getTagName(),
                                                                                                  t13 = xercesc::XMLString::transcode("lane")) == 0)
                                            {
                                                int laneId = atoi(cs = xercesc::XMLString::transcode(
                                                                      laneElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                                std::string laneType(cs = xercesc::XMLString::transcode(
                                                                         laneElement->getAttribute(t12 = xercesc::XMLString::transcode("type"))));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                                std::string laneLevel(cs = xercesc::XMLString::transcode(
                                                                          laneElement->getAttribute(t12 = xercesc::XMLString::transcode("level"))));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                                ...
                                                for (unsigned int childIndex = 0; childIndex < laneChildrenList->getLength(); ++childIndex)
                                                {
                                                    ...
                                                    else if (xercesc::XMLString::compareIString(laneChildElement->getTagName(),
                                                                                                t14 = xercesc::XMLString::transcode("link")) == 0)
                                                    {
                                                        ...
                                                        {
                                                            linkChildElement =
                                                                dynamic_cast<xercesc::DOMElement *>(linkChildrenList->item(childIndex));
                                                            if (!linkChildElement)
                                                            {
                                                            }
                                                            else if (xercesc::XMLString::compareIString(
                                                                         linkChildElement->getTagName(),
                                                                         t15 = xercesc::XMLString::transcode("predecessor")) == 0)
                                                            {
                                                                int predecessorId =
                                                                    atoi(cs = xercesc::XMLString::transcode(linkChildElement->getAttribute(
                                                                             t12 = xercesc::XMLString::transcode("id"))));
                                                                xercesc::XMLString::release(&t12);
                                                                xercesc::XMLString::release(&cs);
                                                                lane->setPredecessor(predecessorId);
                                                                         ...
                                                                         linkChildElement->getTagName(),
                                                                         t16 = xercesc::XMLString::transcode("successor")) == 0)
                                                            {
                                                                int successorId =
                                                                    atoi(cs = xercesc::XMLString::transcode(linkChildElement->getAttribute(
                                                                             t12 = xercesc::XMLString::transcode("id"))));
                                                            ...
                                                            xercesc::XMLString::release(&t16);
                                                                                                ...
                                                                                                t15 = xercesc::XMLString::transcode("width")) == 0)
                                                    {
                                                        double widthStart = atof(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                     t12 = xercesc::XMLString::transcode("sOffset"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        double widthA = atof(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                 t12 = xercesc::XMLString::transcode("a"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        double widthB = atof(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                 t12 = xercesc::XMLString::transcode("b"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        double widthC = atof(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                 t12 = xercesc::XMLString::transcode("c"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        double widthD = atof(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                 t12 = xercesc::XMLString::transcode("d"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        lane->addWidth(widthStart, widthA, widthB, widthC, widthD);
                                                                                                ...
                                                                                                t16 = xercesc::XMLString::transcode("roadMark")) == 0)
                                                    {
                                                        double roadMarkStart = atof(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                        t12 = xercesc::XMLString::transcode("sOffset"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        double roadMarkWidth = atof(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                        t12 = xercesc::XMLString::transcode("width"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        std::string roadMarkType(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                     t12 = xercesc::XMLString::transcode("type"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        std::string roadMarkWeight(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                       t12 = xercesc::XMLString::transcode("weight"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        std::string roadMarkColor(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                      t12 = xercesc::XMLString::transcode("color"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        std::string roadMarkLaneChange(
                                                            cs = xercesc::XMLString::transcode(
                                                                laneChildElement->getAttribute(t12 = xercesc::XMLString::transcode("laneChange"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        lane->addRoadMark(new RoadMark(roadMarkStart,
                                                                                       roadMarkWidth,
                                                                                       roadMarkType,
                                                                                       roadMarkWeight,
                                                                                       roadMarkColor,
                                                    ...
                                                    // Neu Andreas 27-11-2012
                                                                                                ...
                                                                                                t17 = xercesc::XMLString::transcode("speed")) == 0)
                                                    {
                                                        double speedLimitStart =
                                                            atof(cs = xercesc::XMLString::transcode(
                                                                     laneChildElement->getAttribute(t12 = xercesc::XMLString::transcode("sOffset"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        double speedLimitNum = atof(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                        t12 = xercesc::XMLString::transcode("max"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        double factor = 1.0;
                                                        if (laneChildElement->getAttribute(t18 = xercesc::XMLString::transcode("unit")))
                                                        {
                                                            std::string speedUnit = cs = xercesc::XMLString::transcode(
                                                                laneChildElement->getAttribute(t12 = xercesc::XMLString::transcode("unit")));
                                                            xercesc::XMLString::release(&t12);
                                                            xercesc::XMLString::release(&cs);
                                                            if (speedUnit == "mph")
                                                                factor = 0.44704;
                                                        ...
                                                        xercesc::XMLString::release(&t18);
                                                                                                ...
                                                                                                t18 = xercesc::XMLString::transcode("height")) == 0)
                                                    {
                                                        double heightStart = atof(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                      t12 = xercesc::XMLString::transcode("sOffset"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        double inner = atof(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                t12 = xercesc::XMLString::transcode("inner"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        double outer = atof(cs = xercesc::XMLString::transcode(laneChildElement->getAttribute(
                                                                                t12 = xercesc::XMLString::transcode("outer"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                    ...
                                    if (laneSectionChildElement &&
                                        (xercesc::XMLString::compareIString(laneSectionChildElement->getTagName(),
                                                                            t9 = xercesc::XMLString::transcode("left")) == 0 ||
                                         xercesc::XMLString::compareIString(laneSectionChildElement->getTagName(),
                                                                            t10 = xercesc::XMLString::transcode("right")) == 0))
                                    {
                                        ...
                                        for (unsigned int childIndex = 0; childIndex < batterList->getLength(); ++childIndex)
                                        {
                                            ...
                                            if (batterElement &&
                                                xercesc::XMLString::compareIString(batterElement->getTagName(),
                                                                                   t11 = xercesc::XMLString::transcode("batter")) == 0)
                                            {
                                                int batterId = atoi(cs = xercesc::XMLString::transcode(
                                                                        batterElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                                std::string tessellateString(cs = xercesc::XMLString::transcode(batterElement->getAttribute(
                                                                                 t12 = xercesc::XMLString::transcode("tessellate"))));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                                ...
                                                for (unsigned int childIndex = 0; childIndex < batterChildrenList->getLength(); ++childIndex)
                                                {
                                                    ...
                                                    else if (xercesc::XMLString::compareIString(batterChildElement->getTagName(),
                                                                                                t13 = xercesc::XMLString::transcode("width")) == 0)
                                                    {
                                                        double widthStart = atof(cs = xercesc::XMLString::transcode(batterChildElement->getAttribute(
                                                                                     t12 = xercesc::XMLString::transcode("sOffset"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        double widthA = atof(cs = xercesc::XMLString::transcode(batterChildElement->getAttribute(
                                                                                 t12 = xercesc::XMLString::transcode("a"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        batter->addBatterWidth(widthStart, widthA);
                                                                                                ...
                                                                                                t14 = xercesc::XMLString::transcode("fall")) == 0)
                                                    {
                                                        double widthStart = atof(cs = xercesc::XMLString::transcode(batterChildElement->getAttribute(
                                                                                     t12 = xercesc::XMLString::transcode("sOffset"))));
                                                        xercesc::XMLString::release(&t12);
                            ...
                            else if (lanesChildElement && xercesc::XMLString::compareIString(lanesChildElement->getTagName(),
                                                                                             t9 = xercesc::XMLString::transcode("laneOffset")) == 0)
                            {
                                double widthStart = atof(
                                    cs = xercesc::XMLString::transcode(lanesChildElement->getAttribute(t12 = xercesc::XMLString::transcode("s"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double widthA = atof(
                                    cs = xercesc::XMLString::transcode(lanesChildElement->getAttribute(t12 = xercesc::XMLString::transcode("a"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double widthB = atof(
                                    cs = xercesc::XMLString::transcode(lanesChildElement->getAttribute(t12 = xercesc::XMLString::transcode("b"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double widthC = atof(
                                    cs = xercesc::XMLString::transcode(lanesChildElement->getAttribute(t12 = xercesc::XMLString::transcode("c"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double widthD = atof(
                                    cs = xercesc::XMLString::transcode(lanesChildElement->getAttribute(t12 = xercesc::XMLString::transcode("d"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                    ...
                    else if (xercesc::XMLString::compareIString(roadChildElement->getTagName(), t8 = xercesc::XMLString::transcode("objects")) == 0)
                    {
                        ...
                        for (unsigned int childIndex = 0; childIndex < objectsChildrenList->getLength(); ++childIndex)
                        {
                            ...
                            if (objectElement &&
                                xercesc::XMLString::compareIString(objectElement->getTagName(), t9 = xercesc::XMLString::transcode("object")) == 0)
                            {
                                std::string type(
                                    cs = xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("type"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                if (type != "simplePole")
                                {
                                    std::string name(
                                        cs = xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("name"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    std::string id(
                                        cs = xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    std::string file(cs = xercesc::XMLString::transcode(
                                                         objectElement->getAttribute(t12 = xercesc::XMLString::transcode("modelFile"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    std::string textureFile(cs = xercesc::XMLString::transcode(
                                                                objectElement->getAttribute(t12 = xercesc::XMLString::transcode("textureFile"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);

                                    double s = atof(
                                        cs = xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("s"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double t = atof(
                                        cs = xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("t"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double zOffset = atof(cs = xercesc::XMLString::transcode(
                                                              objectElement->getAttribute(t12 = xercesc::XMLString::transcode("zOffset"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double validLength = atof(cs = xercesc::XMLString::transcode(
                                                                  objectElement->getAttribute(t12 = xercesc::XMLString::transcode("validLength"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);

                                    std::string orientationString(cs = xercesc::XMLString::transcode(objectElement->getAttribute(
                                                                      t12 = xercesc::XMLString::transcode("orientation"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    ...
                                    double length = atof(cs = xercesc::XMLString::transcode(
                                                             objectElement->getAttribute(t12 = xercesc::XMLString::transcode("length"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double width = atof(cs = xercesc::XMLString::transcode(
                                                            objectElement->getAttribute(t12 = xercesc::XMLString::transcode("width"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double radius = atof(cs = xercesc::XMLString::transcode(
                                                             objectElement->getAttribute(t12 = xercesc::XMLString::transcode("radius"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double height = atof(cs = xercesc::XMLString::transcode(
                                                             objectElement->getAttribute(t12 = xercesc::XMLString::transcode("height"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double hdg = atof(
                                        cs = xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("hdg"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double pitch = atof(cs = xercesc::XMLString::transcode(
                                                            objectElement->getAttribute(t12 = xercesc::XMLString::transcode("pitch"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double roll = atof(
                                        cs = xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("roll"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    ...
                                    for (unsigned int childIndex = 0; childIndex < objectChildrenList->getLength(); ++childIndex)
                                    {
                                        ...
                                        {
                                            if (xercesc::XMLString::compareIString(objectChildElement->getTagName(),
                                                                                   t10 = xercesc::XMLString::transcode("repeat")) == 0)
                                            {
                                                double repeatS = atof(cs = xercesc::XMLString::transcode(objectChildElement->getAttribute(
                                                                          t12 = xercesc::XMLString::transcode("s"))));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                                double repeatLength = atof(cs = xercesc::XMLString::transcode(objectChildElement->getAttribute(
                                                                               t12 = xercesc::XMLString::transcode("length"))));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                                double repeatDistance = atof(cs = xercesc::XMLString::transcode(objectChildElement->getAttribute(
                                                                                 t12 = xercesc::XMLString::transcode("distance"))));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                                roadObject->setObjectRepeat(repeatS, repeatLength, repeatDistance);
                                            }
                                            else if (xercesc::XMLString::compareIString(objectChildElement->getTagName(),
                                                                                        t11 = xercesc::XMLString::transcode("outline")) == 0)
                                            {
                                                ...
                                                for (unsigned int childIndex = 0; childIndex < outlineChildrenList->getLength(); ++childIndex)
                                                {
                                                    ...
                                                    {
                                                        float height, u, v, z;
                                                        height = atof(cs = xercesc::XMLString::transcode(outlineChildElement->getAttribute(
                                                                          t12 = xercesc::XMLString::transcode("height"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        u = atof(cs = xercesc::XMLString::transcode(
                                                                     outlineChildElement->getAttribute(t12 = xercesc::XMLString::transcode("u"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        v = atof(cs = xercesc::XMLString::transcode(
                                                                     outlineChildElement->getAttribute(t12 = xercesc::XMLString::transcode("v"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                        z = atof(cs = xercesc::XMLString::transcode(
                                                                     outlineChildElement->getAttribute(t12 = xercesc::XMLString::transcode("z"))));
                                                        xercesc::XMLString::release(&t12);
                                                        xercesc::XMLString::release(&cs);
                                                ...
                                                roadObject->setOutline(ro);
                                                                                        ...
                                                                                        t13 = xercesc::XMLString::transcode("userData")) == 0)
                                            {
                                                std::string code = cs = xercesc::XMLString::transcode(
                                                    objectChildElement->getAttribute(t12 = xercesc::XMLString::transcode("code")));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                                if (code == "modelFile")
                                                {
                                                    roadObject->setFileName(cs = xercesc::XMLString::transcode(objectChildElement->getAttribute(
                                                                                t12 = xercesc::XMLString::transcode("value"))));
                                                    xercesc::XMLString::release(&t12);
                                                    xercesc::XMLString::release(&cs);
                                                }
                                                else
                                                {
                                                    roadObject->setTexture(cs = xercesc::XMLString::transcode(objectChildElement->getAttribute(
                                                                               t12 = xercesc::XMLString::transcode("value"))));
                                                    xercesc::XMLString::release(&t12);
                                                    xercesc::XMLString::release(&cs);
                                                }
                            ...
                            else if (objectElement && xercesc::XMLString::compareIString(objectElement->getTagName(),
                                                                                         t10 = xercesc::XMLString::transcode("crosswalk")) == 0)
                            {
                                ...
                                // Get attributes
                                std::string tmp = "";
                                id = cs = xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("id")));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                name = cs = xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("name")));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                s = atof(cs = xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("s"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                length = atof(
                                    cs = xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("length"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                tmp = cs =
                                    xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("crossProb")));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                if (tmp.length() > 0)
                                    crossProb = atof(tmp.c_str());
                                tmp = cs =
                                    xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("resetTime")));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                if (tmp.length() > 0)
                                    resetTime = atof(tmp.c_str());
                                tmp = cs = xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("type")));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                if (tmp.length() > 0)
                                    type = std::string(tmp);
                                tmp = cs =
                                    xercesc::XMLString::transcode(objectElement->getAttribute(t12 = xercesc::XMLString::transcode("debugLvl")));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                if (tmp.length() > 0)
                                ...
                                for (unsigned int childIndex = 0; childIndex < crosswChildrenList->getLength(); ++childIndex)
                                {
                                    ...
                                    if (crosswChildElement &&
                                        xercesc::XMLString::compareIString(crosswChildElement->getTagName(),
                                                                           t11 = xercesc::XMLString::transcode("validity")) == 0)
                                    {
                                        ...
                                        // Get attributes
                                        fromLane = atoi(cs = xercesc::XMLString::transcode(
                                                            objectElement->getAttribute(t12 = xercesc::XMLString::transcode("fromLane"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                                        toLane = atoi(cs = xercesc::XMLString::transcode(
                                                          objectElement->getAttribute(t12 = xercesc::XMLString::transcode("toLane"))));
                                        xercesc::XMLString::release(&t12);
                                        xercesc::XMLString::release(&cs);
                    ...
                    else if (xercesc::XMLString::compareIString(roadChildElement->getTagName(), t9 = xercesc::XMLString::transcode("signals")) == 0)
                    {
                        ...
                        for (unsigned int childIndex = 0; childIndex < signalsChildrenList->getLength(); ++childIndex)
                        {
                            ...
                            if (signalElement &&
                                xercesc::XMLString::compareIString(signalElement->getTagName(), t10 = xercesc::XMLString::transcode("signal")) == 0)
                            {
                                std::string id(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                std::string name(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("name"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);

                                double s =
                                    atof(cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("s"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double t =
                                    atof(cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("t"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double size = atof(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("size"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);

                                std::string dynamicString(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("dynamic"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                bool dynamic = false;
                                ...
                                std::string orientationString(cs = xercesc::XMLString::transcode(
                                                                  signalElement->getAttribute(t12 = xercesc::XMLString::transcode("orientation"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                ...
                                double zOffset = atof(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("zOffset"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                std::string country(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("country"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                int type = atoi(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("type"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                int subtype = atoi(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("subtype"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                std::string subclass(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("subclass"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double value = atof(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("value"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double hdg = atof(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("hOffset"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double pitch = atof(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("pitch"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double roll = atof(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("roll"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                std::string unit(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("unit"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                std::string text(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("text"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double width = atof(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("width"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double height = atof(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("height"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                ...
                                for (unsigned int childIndex = 0; childIndex < signalChildrenList->getLength(); ++childIndex)
                                {
                                    ...
                                    {
                                        if (xercesc::XMLString::compareIString(signalChildElement->getTagName(),
                                                                               t10 = xercesc::XMLString::transcode("userData")) == 0)
                                        {
                                            std::string code = cs = xercesc::XMLString::transcode(
                                                signalChildElement->getAttribute(t12 = xercesc::XMLString::transcode("code")));
                                            xercesc::XMLString::release(&t12);
                                            xercesc::XMLString::release(&cs);
                                            if (code == "size")
                                            {
                                                size = atof(cs = xercesc::XMLString::transcode(
                                                                signalChildElement->getAttribute(t12 = xercesc::XMLString::transcode("value"))));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                            }
                                            else if (code == "subclass")
                                            {
                                                subclass = cs = xercesc::XMLString::transcode(
                                                    signalChildElement->getAttribute(t12 = xercesc::XMLString::transcode("value")));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                            }
                                ...
                                if ((country == "China") && (type <= 3))
                                {
                                    if (subclass.size() != 0)
                                    {
                                        ...
                                        while (it != subclass.end() && isdigit(*it))
                                            ++it;
                                        if (it == subclass.end())
                                        {
                                ...
                                {
                                    roadSignal = new TrafficLightSignal(id,
                                                                        name,
                                                                        s,
                                                                        t,
                                                                        dynamic,
                    ...
                    else if (xercesc::XMLString::compareIString(roadChildElement->getTagName(), t10 = xercesc::XMLString::transcode("sensors")) == 0)
                    {
                        ...
                        for (unsigned int childIndex = 0; childIndex < signalsChildrenList->getLength(); ++childIndex)
                        {
                            signalElement = dynamic_cast<xercesc::DOMElement *>(signalsChildrenList->item(childIndex));
                            if (signalElement &&
                                xercesc::XMLString::compareIString(signalElement->getTagName(), t11 = xercesc::XMLString::transcode("sensor")) == 0)
                            {
                                std::string id(
                                    cs = xercesc::XMLString::transcode(signalElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
                                xercesc::XMLString::release(&t12);
                    ...
                    else if (xercesc::XMLString::compareIString(roadChildElement->getTagName(), t11 = xercesc::XMLString::transcode("surface")) == 0)
                    {
                        ...
                        for (unsigned int childIndex = 0; childIndex < surfaceChildrenList->getLength(); ++childIndex)
                        {
                            ...
                            if (surfaceChildElement && xercesc::XMLString::compareIString(surfaceChildElement->getTagName(),
                                                                                          t13 = xercesc::XMLString::transcode("CRG")) == 0)
                            {
                                std::string file(cs = xercesc::XMLString::transcode(
                                                     surfaceChildElement->getAttribute(t12 = xercesc::XMLString::transcode("file"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double sStart = atof(cs = xercesc::XMLString::transcode(
                                                         surfaceChildElement->getAttribute(t12 = xercesc::XMLString::transcode("sStart"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double sEnd = atof(cs = xercesc::XMLString::transcode(
                                                       surfaceChildElement->getAttribute(t12 = xercesc::XMLString::transcode("sEnd"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                std::string orientString(cs = xercesc::XMLString::transcode(
                                                             surfaceChildElement->getAttribute(t12 = xercesc::XMLString::transcode("orientation"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                OpenCRGSurface::SurfaceOrientation orientation =
                                    (orientString == "opposite") ? OpenCRGSurface::OPPOSITE : OpenCRGSurface::SAME;
                                double sOffset = atof(cs = xercesc::XMLString::transcode(
                                                          surfaceChildElement->getAttribute(t12 = xercesc::XMLString::transcode("sOffset"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double tOffset = atof(cs = xercesc::XMLString::transcode(
                                                          surfaceChildElement->getAttribute(t12 = xercesc::XMLString::transcode("tOffset"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double zOffset = atof(cs = xercesc::XMLString::transcode(
                                                          surfaceChildElement->getAttribute(t12 = xercesc::XMLString::transcode("zOffset"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                std::string zScaleString(cs = xercesc::XMLString::transcode(
                                                             surfaceChildElement->getAttribute(t12 = xercesc::XMLString::transcode("zScale"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double zScale = 1.0;
                                ...
                                double hOffset = atof(cs = xercesc::XMLString::transcode(
                                                          surfaceChildElement->getAttribute(t12 = xercesc::XMLString::transcode("hOffset"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);

                                // crgSurface *surface = new crgSurface(file, sStart, sEnd, orientation, sOffset, tOffset, zOffset, zScale);
                                OpenCRGSurface *surface =
                                    new OpenCRGSurface(file, sStart, sEnd, orientation, sOffset, tOffset, zOffset, zScale, hOffset);
            ...
            else if (documentChildElement &&
                     xercesc::XMLString::compareIString(documentChildElement->getTagName(), t2 = xercesc::XMLString::transcode("header")) == 0)
            {
                header.date = cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t3 = xercesc::XMLString::transcode("date")));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                header.name = cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t3 = xercesc::XMLString::transcode("name")));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                header.north =
                    atof(cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t3 = xercesc::XMLString::transcode("north"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                header.east =
                    atof(cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t3 = xercesc::XMLString::transcode("east"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                header.south =
                    atof(cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t3 = xercesc::XMLString::transcode("south"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                header.west =
                    atof(cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t3 = xercesc::XMLString::transcode("west"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                header.revMajor =
                    atoi(cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t3 = xercesc::XMLString::transcode("atoi"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                header.revMinor =
                    atoi(cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t3 = xercesc::XMLString::transcode("atoi"))));
                ...
                xercesc::XMLString::release(&cs);
                header.version =
                    atof(cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t3 = xercesc::XMLString::transcode("version"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                header.xoffset =
                    atof(cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t3 = xercesc::XMLString::transcode("xoffset"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                header.yoffset =
                    atof(cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t3 = xercesc::XMLString::transcode("yoffset"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                header.zoffset =
                    atof(cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t3 = xercesc::XMLString::transcode("zoffset"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                xercesc::DOMNodeList *geoRefChildrenList = documentChildElement->getChildNodes();

                xercesc::DOMElement *geoRefChildElement;
                for (unsigned int childIndex = 0; childIndex < geoRefChildrenList->getLength(); ++childIndex)
                {
                    geoRefChildElement = dynamic_cast<xercesc::DOMElement *>(geoRefChildrenList->item(childIndex));
                    if (geoRefChildElement &&
                        xercesc::XMLString::compareIString(geoRefChildElement->getTagName(), t2 = xercesc::XMLString::transcode("geoReference")) == 0)
                    {
                        header.geoReference = cs = xercesc::XMLString::transcode(geoRefChildElement->getTextContent());
                    }
                }

                // custom modification - init map SRS conversion
                InitConvertMapFromOdrHeader(header.north,header.south,header.east,header.west,header.geoReference.c_str());
        ...
        for (unsigned int childIndex = 0; childIndex < documentChildrenList->getLength(); ++childIndex)
        {
            documentChildElement = dynamic_cast<xercesc::DOMElement *>(documentChildrenList->item(childIndex));
            if (documentChildElement &&
                xercesc::XMLString::compareIString(documentChildElement->getTagName(), t3 = xercesc::XMLString::transcode("controller")) == 0)
            {
                std::string controllerIdString = cs =
                    xercesc::XMLString::transcode(documentChildElement->getAttribute(t12 = xercesc::XMLString::transcode("id")));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                std::string controllerNameString = cs =
                    xercesc::XMLString::transcode(documentChildElement->getAttribute(t12 = xercesc::XMLString::transcode("name")));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                std::string script = cs =
                    xercesc::XMLString::transcode(documentChildElement->getAttribute(t12 = xercesc::XMLString::transcode("script")));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                double cycleTime =
                    atof(cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t12 = xercesc::XMLString::transcode("cycleTime"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                ...
                for (unsigned int childIndex = 0; childIndex < controllerChildrenList->getLength(); ++childIndex)
                {
                    ...
                    if (controllerChildElement &&
                        xercesc::XMLString::compareIString(controllerChildElement->getTagName(), t4 = xercesc::XMLString::transcode("userData")) == 0)
                    {
                        std::string code = cs =
                            xercesc::XMLString::transcode(controllerChildElement->getAttribute(t12 = xercesc::XMLString::transcode("code")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (code == "cycleTime")
                        {
                            cycleTime = atof(cs = xercesc::XMLString::transcode(
                                                 controllerChildElement->getAttribute(t12 = xercesc::XMLString::transcode("value"))));
                            xercesc::XMLString::release(&t12);
                            xercesc::XMLString::release(&cs);
                            if (script != "")
                            {
                        ...
                        {
                            script = cs =
                                xercesc::XMLString::transcode(controllerChildElement->getAttribute(t12 = xercesc::XMLString::transcode("value")));
                            xercesc::XMLString::release(&t12);
                            xercesc::XMLString::release(&cs);
                        }
                    }

                    else if (controller->isScriptInitialized() && controllerChildElement &&
                             xercesc::XMLString::compareIString(controllerChildElement->getTagName(),
                                                                t5 = xercesc::XMLString::transcode("control")) == 0)
                    {
                        std::string signalId = cs =
                            xercesc::XMLString::transcode(controllerChildElement->getAttribute(t12 = xercesc::XMLString::transcode("signalId")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        std::string type = cs =
                            xercesc::XMLString::transcode(controllerChildElement->getAttribute(t12 = xercesc::XMLString::transcode("type")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                    ...
                    if (controller->isScriptInitialized() && controllerChildElement &&
                        xercesc::XMLString::compareIString(controllerChildElement->getTagName(), t6 = xercesc::XMLString::transcode("trigger")) == 0)
                    {
                        std::string sensorId = cs =
                            xercesc::XMLString::transcode(controllerChildElement->getAttribute(t12 = xercesc::XMLString::transcode("sensorId")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        std::string function = cs =
                            xercesc::XMLString::transcode(controllerChildElement->getAttribute(t12 = xercesc::XMLString::transcode("function")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
        ...
        for (unsigned int childIndex = 0; childIndex < documentChildrenList->getLength(); ++childIndex)
        {
            documentChildElement = dynamic_cast<xercesc::DOMElement *>(documentChildrenList->item(childIndex));
            if (documentChildElement &&
                xercesc::XMLString::compareIString(documentChildElement->getTagName(), t3 = xercesc::XMLString::transcode("junction")) == 0)
            {
                std::string junctionId(
                    cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                std::string junctionName(
                    cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t12 = xercesc::XMLString::transcode("name"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                ...
                for (unsigned int childIndex = 0; childIndex < junctionChildrenList->getLength(); ++childIndex)
                {
                    ...
                    else if (xercesc::XMLString::compareIString(junctionChildElement->getTagName(),
                                                                t4 = xercesc::XMLString::transcode("connection")) == 0)
                    {
                        std::string connectionId(
                            cs = xercesc::XMLString::transcode(junctionChildElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        std::string inRoadString(cs = xercesc::XMLString::transcode(
                                                     junctionChildElement->getAttribute(t12 = xercesc::XMLString::transcode("incomingRoad"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        std::string connPathString(cs = xercesc::XMLString::transcode(
                                                       junctionChildElement->getAttribute(t12 = xercesc::XMLString::transcode("connectingRoad"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        std::string contactPoint(cs = xercesc::XMLString::transcode(
                                                     junctionChildElement->getAttribute(t12 = xercesc::XMLString::transcode("contactPoint"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        std::string numeratorString(
                            cs = xercesc::XMLString::transcode(junctionChildElement->getAttribute(t12 = xercesc::XMLString::transcode("numerator"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        ...
                        for (unsigned int childIndex = 0; childIndex < childrenList->getLength(); ++childIndex)
                        {
                            ...
                            if (childElement &&
                                (xercesc::XMLString::compareIString(childElement->getTagName(), t5 = xercesc::XMLString::transcode("userData")) == 0))
                            {
                                numeratorString = cs =
                                    xercesc::XMLString::transcode(childElement->getAttribute(t12 = xercesc::XMLString::transcode("value")));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                            }
                            xercesc::XMLString::release(&t5);
                        ...
                        {
                            std::cerr << "Junction id " << junction->getId() << ": Connection id: " << connectionId
                                      << ": No incoming road defined with id " << inRoadString << "..." << std::endl;
                        }
                        else
                        {
                            ...
                            {
                                std::cerr << "Junction id " << junction->getId() << ": Connection id: " << connectionId
                                          << ": Incoming Road with id declaration " << inRoadString << " not of type road..." << std::endl;
                            }
                            else
                            {
                                ...
                                {
                                    std::cerr << "Junction id " << junction->getId() << ": Connection id: " << connectionId
                                              << ": No connecting path defined with id " << connPathString << "..." << std::endl;
                                }
                                else
                                {
                                    ...
                                    {
                                        std::cerr << "Junction id " << junction->getId() << ": Connection id: " << connectionId
                                                  << ": Connecting Path with id declaration " << connPathString << " not of type road..."
                                                  << std::endl;
                                    }
                                    else
                                    {
                                        ...
                                        for (unsigned int childIndex = 0; childIndex < connectionChildrenList->getLength(); ++childIndex)
                                        {
                                            ...
                                            else if (xercesc::XMLString::compareIString(connectionChildElement->getTagName(),
                                                                                        t5 = xercesc::XMLString::transcode("laneLink")) == 0)
                                            {
                                                int from = atoi(cs = xercesc::XMLString::transcode(connectionChildElement->getAttribute(
                                                                    t12 = xercesc::XMLString::transcode("from"))));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                                int to = atoi(cs = xercesc::XMLString::transcode(
                                                                  connectionChildElement->getAttribute(t12 = xercesc::XMLString::transcode("to"))));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                            ...
                                            xercesc::XMLString::release(&t5);
                                                                ...
                                                                t5 = xercesc::XMLString::transcode("controller")) == 0)
                    {
                        ...
                        std::string controlType(
                            cs = xercesc::XMLString::transcode(junctionChildElement->getAttribute(t12 = xercesc::XMLString::transcode("type"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
        ...
        for (unsigned int childIndex = 0; childIndex < documentChildrenList->getLength(); ++childIndex)
        {
            documentChildElement = dynamic_cast<xercesc::DOMElement *>(documentChildrenList->item(childIndex));
            if (documentChildElement &&
                xercesc::XMLString::compareIString(documentChildElement->getTagName(), t3 = xercesc::XMLString::transcode("fiddleyard")) == 0)
            {
                std::string fiddleyardId(
                    cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                std::string fiddleyardName(
                    cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t12 = xercesc::XMLString::transcode("name"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                ...
                for (unsigned int childIndex = 0; childIndex < fiddleyardChildrenList->getLength(); ++childIndex)
                {
                    ...
                    else if (xercesc::XMLString::compareIString(fiddleyardChildElement->getTagName(), t4 = xercesc::XMLString::transcode("link")) ==
                             0)
                    {
                        std::string type(cs = xercesc::XMLString::transcode(
                                             fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("elementType"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        std::string id(cs = xercesc::XMLString::transcode(
                                           fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("elementId"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        std::string contactPoint(cs = xercesc::XMLString::transcode(
                                                     fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("contactPoint"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        ...
                        if (type == "road")
                        {
                            ...
                            if (roadMapIt == roadIdMap.end())
                            {
                                std::cerr << "Fiddleyard " << fiddleyard->getName() << ": Unknown link road id: " << id << "... Ignoring..."
                                          << std::endl;
                            }
                            else
                            {
                        ...
                        else if (type == "junction")
                        {
                            ...
                            {
                                std::cerr << "Fiddleyard " << fiddleyard->getName() << ": Unknown link junction id: " << id << "... Ignoring..."
                                          << std::endl;
                            }
                            else
                            {
                        ...
                        if (!tarmac)
                        {
                            std::cerr << "Fiddleyard " << fiddleyard->getName() << ", link tag: element id: " << id << " is not of type tarmac..."
                                      << std::endl;
                        }
                        else
                        {
                            ...
                            {
                                std::cerr << "Fiddleyard " << fiddleyard->getName() << ": link id: " << id << ": No direction defined..."
                                          << std::endl;
                            }
                    ...
                    else if (xercesc::XMLString::compareIString(fiddleyardChildElement->getTagName(), t5 = xercesc::XMLString::transcode("source")) ==
                             0)
                    {
                        std::string id(
                            cs = xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        int lane = atoi(
                            cs = xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("lane"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        double starttime = atof(cs = xercesc::XMLString::transcode(
                                                    fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("startTime"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        double repeattime = atof(cs = xercesc::XMLString::transcode(
                                                     fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("repeatTime"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        double vel = atof(cs = xercesc::XMLString::transcode(
                                              fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("velocity"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        double velDev = atof(cs = xercesc::XMLString::transcode(
                                                 fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("velocityDeviance"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        ...
                        for (unsigned int childIndex = 0; childIndex < sourceChildrenList->getLength(); ++childIndex)
                        {
                            ...
                            if (sourceChildElement && xercesc::XMLString::compareIString(sourceChildElement->getTagName(),
                                                                                         t6 = xercesc::XMLString::transcode("vehicle")) == 0)
                            {
                                std::string id(
                                    cs = xercesc::XMLString::transcode(sourceChildElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double numerator = atof(cs = xercesc::XMLString::transcode(
                                                            sourceChildElement->getAttribute(t12 = xercesc::XMLString::transcode("numerator"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                    ...
                    else if (xercesc::XMLString::compareIString(fiddleyardChildElement->getTagName(), t6 = xercesc::XMLString::transcode("sink")) ==
                             0)
                    {
                        std::string id(
                            cs = xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
        ...
        for (unsigned int childIndex = 0; childIndex < documentChildrenList->getLength(); ++childIndex)
        {
            documentChildElement = dynamic_cast<xercesc::DOMElement *>(documentChildrenList->item(childIndex));
            if (documentChildElement &&
                xercesc::XMLString::compareString(documentChildElement->getTagName(), t3 = xercesc::XMLString::transcode("carpool")) == 0)
            {
                // std::string carpoolId(xercesc::XMLString::transcode(documentChildElement->getAttribute(xercesc::XMLString::transcode("id"))));
                std::string carpoolName(
                    cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t12 = xercesc::XMLString::transcode("name"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                ...
                for (unsigned int childIndex = 0; childIndex < carpoolChildrenList->getLength(); ++childIndex)
                {
                    ...
                    {
                        std::string poolId(
                            cs = xercesc::XMLString::transcode(carpoolChildElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        std::string poolName(
                            cs = xercesc::XMLString::transcode(carpoolChildElement->getAttribute(t12 = xercesc::XMLString::transcode("name"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        // double repeattime = atof(cs = xercesc::XMLString::transcode(carpoolChildElement->getAttribute(t12 =
                        // xercesc::XMLString::transcode("repeatTime")))); xercesc::XMLString::release(&t12); xercesc::XMLString::release(&cs);
                        double vel = atof(
                            cs = xercesc::XMLString::transcode(carpoolChildElement->getAttribute(t12 = xercesc::XMLString::transcode("velocity"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        double velDev = atof(cs = xercesc::XMLString::transcode(
                                                 carpoolChildElement->getAttribute(t12 = xercesc::XMLString::transcode("velocityDeviance"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        double poolNumerator = atof(
                            cs = xercesc::XMLString::transcode(carpoolChildElement->getAttribute(t12 = xercesc::XMLString::transcode("numerator"))));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        ...
                        for (unsigned int childIndex = 0; childIndex < poolChildrenList->getLength(); ++childIndex)
                        {
                            ...
                            if (poolChildElement &&
                                xercesc::XMLString::compareString(poolChildElement->getTagName(), t5 = xercesc::XMLString::transcode("vehicle")) == 0)
                            {
                                std::string id(
                                    cs = xercesc::XMLString::transcode(poolChildElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                double numerator = atof(cs = xercesc::XMLString::transcode(
                                                            poolChildElement->getAttribute(t12 = xercesc::XMLString::transcode("numerator"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
        ...
        for (unsigned int childIndex = 0; childIndex < documentChildrenList->getLength(); ++childIndex)
        {
            documentChildElement = dynamic_cast<xercesc::DOMElement *>(documentChildrenList->item(childIndex));
            if (documentChildElement &&
                xercesc::XMLString::compareIString(documentChildElement->getTagName(), t3 = xercesc::XMLString::transcode("pedFiddleyard")) == 0)
            {
                std::string fiddleyardId(
                    cs = xercesc::XMLString::transcode(documentChildElement->getAttribute(t12 = xercesc::XMLString::transcode("id"))));
                xercesc::XMLString::release(&t12);
                ...
                std::string tmp    = cs =
                    xercesc::XMLString::transcode(documentChildElement->getAttribute(t12 = xercesc::XMLString::transcode("roadId")));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                if (tmp.length() > 0)
                ...
                for (unsigned int childIndex = 0; childIndex < fiddleyardChildrenList->getLength(); ++childIndex)
                {
                    ...
                    else if (xercesc::XMLString::compareIString(fiddleyardChildElement->getTagName(), t4 = xercesc::XMLString::transcode("source")) ==
                             0)
                    {
                        ...
                        std::string id;
                        tmp = cs = xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("id")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (tmp.length() > 0)
                            id = std::string(tmp);
                        ...
                        double starttime;
                        tmp = cs =
                            xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("startTime")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (tmp.length() > 0)
                        ...
                        double repeattime;
                        tmp = cs =
                            xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("repeatTime")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (tmp.length() > 0)
                        ...
                        double timedev;
                        tmp = cs =
                            xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("timeDeviance")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (tmp.length() > 0)
                        ...
                        int lane;
                        tmp = cs = xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("lane")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (tmp.length() > 0)
                            lane = atoi(tmp.c_str());
                        ...
                        int dir;
                        tmp = cs =
                            xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("direction")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (tmp.length() > 0)
                            dir = atoi(tmp.c_str());
                        ...
                        double sOff;
                        tmp = cs =
                            xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("sOffset")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (tmp.length() > 0)
                            sOff = atof(tmp.c_str());
                        ...
                        double vOff;
                        tmp = cs =
                            xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("vOffset")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (tmp.length() > 0)
                            vOff = atof(tmp.c_str());
                        ...
                        double vel;
                        tmp = cs =
                            xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("velocity")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (tmp.length() > 0)
                            vel = atof(tmp.c_str());
                        ...
                        double velDev;
                        tmp = cs = xercesc::XMLString::transcode(
                            fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("velocityDeviance")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (tmp.length() > 0)
                        ...
                        double acc;
                        tmp = cs =
                            xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("acceleration")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (tmp.length() > 0)
                            acc = atof(tmp.c_str());
                        ...
                        double accDev;
                        tmp = cs = xercesc::XMLString::transcode(
                            fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("accelerationDeviance")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (tmp.length() > 0)
                        ...
                        PedSource *source =
                            new PedSource(fiddleyard, id, starttime, repeattime, timedev, lane, dir, sOff, vOff, vel, velDev, acc, accDev);
                        ...
                        {
                            sourceChildElement = dynamic_cast<xercesc::DOMElement *>(sourceChildrenList->item(childIndex));
                            if (sourceChildElement &&
                                xercesc::XMLString::compareIString(sourceChildElement->getTagName(), t5 = xercesc::XMLString::transcode("ped")) == 0)
                            {
                                std::string id(cs = xercesc::XMLString::transcode(
                                                   sourceChildElement->getAttribute(t12 = xercesc::XMLString::transcode("templateId"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                                std::string num(cs = xercesc::XMLString::transcode(
                                                    sourceChildElement->getAttribute(t12 = xercesc::XMLString::transcode("numerator"))));
                                xercesc::XMLString::release(&t12);
                                xercesc::XMLString::release(&cs);
                    ...
                    else if (xercesc::XMLString::compareIString(fiddleyardChildElement->getTagName(), t5 = xercesc::XMLString::transcode("sink")) ==
                             0)
                    {
                        // Get attributes of this source, provide defaults for any that aren't provided
                        std::string tmp = "";
                        ...
                        double prob;
                        tmp = cs =
                            xercesc::XMLString::transcode(fiddleyardChildElement->getAttribute(t12 = xercesc::XMLString::transcode("sinkProb")));
                        xercesc::XMLString::release(&t12);
                        xercesc::XMLString::release(&cs);
                        if (tmp.length() > 0)
                            prob = atof(tmp.c_str());
        ...
        for (unsigned int roadIndex = 0; roadIndex < roadVector.size(); ++roadIndex)
        {
            ...
            std::string junctionId(
                cs = xercesc::XMLString::transcode(roadDOMMap[road]->getAttribute(t12 = xercesc::XMLString::transcode("junction"))));
            xercesc::XMLString::release(&t12);
            xercesc::XMLString::release(&cs);
            ...
            {
                std::cerr << "Road " << road->getName() << ": Junction id " << junctionId << " is not in element database... Ignoring..."
                          << std::endl;
                road->setJunction(NULL);
            }
            else
            {
                ...
                {
                    std::cerr << "Road " << road->getName() << ": Declared id for junction " << junctionId << " is not a junction... Ignoring..."
                              << std::endl;
                    road->setJunction(NULL);
                }
            }
            ...
            for (unsigned int childIndex = 0; childIndex < roadChildrenList->getLength(); ++childIndex)
            {
                ...
                else if (xercesc::XMLString::compareIString(roadChildElement->getTagName(), t3 = xercesc::XMLString::transcode("link")) == 0)
                {
                    ...
                    for (unsigned int childIndex = 0; childIndex < linkChildrenList->getLength(); ++childIndex)
                    {
                        ...
                        else if (xercesc::XMLString::compareIString(linkChildElement->getTagName(),
                                                                    t4 = xercesc::XMLString::transcode("predecessor")) == 0)
                        {
                            std::string type(cs = xercesc::XMLString::transcode(
                                                 linkChildElement->getAttribute(t12 = xercesc::XMLString::transcode("elementType"))));
                            xercesc::XMLString::release(&t12);
                            xercesc::XMLString::release(&cs);
                            std::string id(
                                cs = xercesc::XMLString::transcode(linkChildElement->getAttribute(t12 = xercesc::XMLString::transcode("elementId"))));
                            xercesc::XMLString::release(&t12);
                            xercesc::XMLString::release(&cs);
                            std::string contactPoint(cs = xercesc::XMLString::transcode(
                                                         linkChildElement->getAttribute(t12 = xercesc::XMLString::transcode("contactPoint"))));
                            xercesc::XMLString::release(&t12);
                            xercesc::XMLString::release(&cs);
                            ...
                            if (type == "road")
                            {
                                ...
                                if (roadMapIt == roadIdMap.end())
                                {
                                    std::cerr << "Road " << road->getName() << ": Unknown predecessor road id: " << id << "... Ignoring..."
                                              << std::endl;
                                }
                                else
                                {
                            ...
                            else if (type == "junction")
                            {
                                ...
                                if (junctionMapIt == junctionIdMap.end())
                                {
                                    std::cerr << "Road " << road->getName() << ": Unknown predecessor junction id: " << id << "... Ignoring..."
                                              << std::endl;
                                }
                                else
                                {
                            ...
                            else if (type == "fiddleyard")
                            {
                                ...
                                {
                                    std::cerr << "Road " << road->getName() << ": Unknown predecessor fiddleyard id: " << id << "... Ignoring..."
                                              << std::endl;
                                }
                                else
                                {
                            ...
                            if (!tarmac)
                            {
                                std::cerr << "Road " << road->getName() << ", predecessor link tag: element id: " << id << " is not of type tarmac..."
                                          << std::endl;
                            }
                            else
                            {
                                ...
                                road->setPredecessorConnection(new TarmacConnection(tarmac, direction));
                                                                    ...
                                                                    t5 = xercesc::XMLString::transcode("successor")) == 0)
                        {
                            std::string type(cs = xercesc::XMLString::transcode(
                                                 linkChildElement->getAttribute(t12 = xercesc::XMLString::transcode("elementType"))));
                            xercesc::XMLString::release(&t12);
                            ...
                            if (type == "road")
                            {
                                ...
                                if (roadMapIt == roadIdMap.end())
                                {
                                    std::cerr << "Road " << road->getName() << ": Unknown successor road id: " << id << "... Ignoring..."
                                              << std::endl;
                                }
                                else
                                {
                            ...
                            else if (type == "junction")
                            {
                                ...
                                if (junctionMapIt == junctionIdMap.end())
                                {
                                    std::cerr << "Road " << road->getName() << ": Unknown successor junction id: " << id << "... Ignoring..."
                                              << std::endl;
                                }
                                else
                                {
                            ...
                            else if (type == "fiddleyard")
                            {
                                ...
                                if (fiddleyardMapIt == fiddleyardIdMap.end())
                                {
                                    std::cerr << "Road " << road->getName() << ": Unknown successor fiddleyard id: " << id << "... Ignoring..."
                                              << std::endl;
                                }
                                else
                                {
                            ...
                            if (!tarmac)
                            {
                                std::cerr << "Road " << road->getName() << ", successor link tag: element id: " << id << " is not of type tarmac..."
                                          << std::endl;
                            }
                            else
                            {
...
std::ostream &vehicleUtil::operator<<(std::ostream &os, RoadSystem *system)
{
    ...
    for (int i = 0; i < system->getNumRoads(); ++i)
    {
        ...
        if (connection)
        {
            os << ", predecessor road id: " << road->getPredecessorConnection()->getConnectingTarmac()->getId()
               << " and name: " << road->getPredecessorConnection()->getConnectingTarmac()->getName();
        }
        else
        {
        ...
        if (connection)
        {
            os << ", successor road id: " << road->getSuccessorConnection()->getConnectingTarmac()->getId()
               << " and name: " << road->getSuccessorConnection()->getConnectingTarmac()->getName() << std::endl;
        }
        else
        {
    ...
    for (int i = 0; i < system->getNumJunctions(); ++i)
    {
        ...
        for (int j = 0; j < junction->getNumIncomingRoads(); ++j)
        {
            ...
            for (PathConnectionSet::iterator connSetIt = connSet.begin(); connSetIt != connSet.end(); ++connSetIt)
            {
                ...
                os << "\t\tPathConnection: " << conn->getId() << ", Connecting Path id: " << path->getId()
                   << ", relativ heading: " << conn->getAngleDifference() << std::endl;
    ...
    for (int i = 0; i < system->getNumFiddleyards(); ++i)
    {
        ...
        os << "\tTarmac connection id: " << conn->getConnectingTarmac()->getId() << ", direction: " << conn->getConnectingTarmacDirection()
           << std::endl;
    }
...
void RoadSystem::parseCinema4dXml(std::string filename)
{
    ...
    if (rootElement)
    {
        ...
        xercesc::DOMNodeList *splineList = rootElement->getElementsByTagName(t1 = xercesc::XMLString::transcode("obj_spline"));
        xercesc::XMLString::release(&t1);
        for (unsigned int splineIt = 0; splineIt < splineList->getLength(); ++splineIt)
        {
            ...
            xercesc::DOMNodeList *stringList = splineElement->getElementsByTagName(t2 = xercesc::XMLString::transcode("string"));
            xercesc::XMLString::release(&t2);
            ...
            for (unsigned int stringIt = 0; stringIt < stringList->getLength(); ++stringIt)
            {
                ...
                stringVar = cs = xercesc::XMLString::transcode(stringElement->getAttribute(t12 = xercesc::XMLString::transcode("v")));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
         ...
         */
            ...
            xercesc::DOMNodeList *vectorArrayList = splineElement->getElementsByTagName(t2 = xercesc::XMLString::transcode("vectorarray"));
            xercesc::XMLString::release(&t2);
            for (unsigned int vectorArrayIt = 0; vectorArrayIt < vectorArrayList->getLength(); ++vectorArrayIt)
            {
                ...
                // int vectorArraySize = atoi(cs = xercesc::XMLString::transcode(vectorArrayElement->getAttribute(t12 =
                // xercesc::XMLString::transcode("size")))); xercesc::XMLString::release(&t12); xercesc::XMLString::release(&cs);
                xercesc::DOMNodeList *vectorList = vectorArrayElement->getElementsByTagName(t1 = xercesc::XMLString::transcode("vector"));
                xercesc::XMLString::release(&t1);
                for (unsigned int vectorIt = 0; vectorIt < vectorList->getLength(); ++vectorIt)
                {
                    ...
                    point.push_back(atof(cs = xercesc::XMLString::transcode(vectorElement->getAttribute(t12 = xercesc::XMLString::transcode("z")))));
                    xercesc::XMLString::release(&t12);
                    xercesc::XMLString::release(&cs);
                    point.push_back(-atof(cs = xercesc::XMLString::transcode(vectorElement->getAttribute(t12 = xercesc::XMLString::transcode("x")))));
                    xercesc::XMLString::release(&t12);
                    xercesc::XMLString::release(&cs);
                    point.push_back(atof(cs = xercesc::XMLString::transcode(vectorElement->getAttribute(t12 = xercesc::XMLString::transcode("y")))));
                    xercesc::XMLString::release(&t12);
                    xercesc::XMLString::release(&cs);
            ...
            for (int laneIt = -numLaneRight; laneIt <= numLaneLeft; ++laneIt)
            {
                ...
                {
                    lane->addRoadMark(new RoadMark(0.0,
                                                   0.12,
                                                   RoadMark::TYPE_SOLID,
                                                   RoadMark::WEIGHT_STANDARD,
                                                   RoadMark::COLOR_STANDARD,
                                                   RoadMark::LANECHANGE_NONE));
                }
                ...
                else
                {
                    lane->addRoadMark(new RoadMark(0.0,
                                                   0.12,
                                                   RoadMark::TYPE_BROKEN,
                                                   RoadMark::WEIGHT_STANDARD,
                                                   RoadMark::COLOR_STANDARD,
                                                   RoadMark::LANECHANGE_BOTH));
                }
            }
        ...
        for (std::map<std::string, std::vector<Road *>>::iterator junctionIt = junctionRoadVectorMap.begin();
             junctionIt != junctionRoadVectorMap.end();
             ++junctionIt)
        {
...
void RoadSystem::parseLandXml(std::string filename)
{
    ...
    if (rootElement)
    {
        xercesc::DOMNodeList *RoadwayList = rootElement->getElementsByTagName(t1 = xercesc::XMLString::transcode("Roadway"));
        xercesc::XMLString::release(&t1);
        xercesc::DOMNodeList *AlignmentList = rootElement->getElementsByTagName(t1 = xercesc::XMLString::transcode("Alignment"));
        xercesc::XMLString::release(&t1);
        ...
        for (unsigned int roadwayIt = 0; roadwayIt < RoadwayList->getLength(); ++roadwayIt)
        {
            ...
            if (roadwayElement)
            {
                std::string name(cs = xercesc::XMLString::transcode(roadwayElement->getAttribute(xercesc::XMLString::transcode("name"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                std::string alignmentRefs(
                    cs = xercesc::XMLString::transcode(roadwayElement->getAttribute(xercesc::XMLString::transcode("alignmentRefs"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                double staStart = atof(cs = xercesc::XMLString::transcode(roadwayElement->getAttribute(xercesc::XMLString::transcode("staStart"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                double staEnd = atof(cs = xercesc::XMLString::transcode(roadwayElement->getAttribute(xercesc::XMLString::transcode("staEnd"))));
                xercesc::XMLString::release(&t12);
                xercesc::XMLString::release(&cs);
                ...
                for (unsigned int alignmentIt = 0; alignmentIt < AlignmentList->getLength(); ++alignmentIt)
                {
                    ...
                    char                *align;
                    if (alignmentElement && std::string(align = xercesc::XMLString::transcode(alignmentElement->getAttribute(
                                                            t1 = xercesc::XMLString::transcode("name")))) == alignmentRefs)
                    {
                        xercesc::DOMNodeList *CoordGeomList = alignmentElement->getElementsByTagName(t2 = xercesc::XMLString::transcode("CoordGeom"));
                        xercesc::XMLString::release(&t2);
                        for (unsigned int coordGeomIt = 0; coordGeomIt < CoordGeomList->getLength(); ++coordGeomIt)
                        {
                            ...
                            {
                                xercesc::DOMElement *coordGeomChildElement =
                                    dynamic_cast<xercesc::DOMElement *>(CoordGeomChildrenList->item(coordGeomChildIt));
                                if (!coordGeomChildElement)
                                {
                                }

                                else if (xercesc::XMLString::compareIString(coordGeomChildElement->getTagName(),
                                                                            t2 = xercesc::XMLString::transcode("Line")) == 0)
                                {
                                    dir = atof(cs = xercesc::XMLString::transcode(
                                                   coordGeomChildElement->getAttribute(t12 = xercesc::XMLString::transcode("dir"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double length = atof(cs = xercesc::XMLString::transcode(
                                                             coordGeomChildElement->getAttribute(t12 = xercesc::XMLString::transcode("length"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    ...
                                    {
                                        xercesc::DOMElement *lineChildElement =
                                            dynamic_cast<xercesc::DOMElement *>(LineChildrenList->item(lineChildIt));
                                        if (lineChildElement && xercesc::XMLString::compareIString(lineChildElement->getTagName(),
                                                                                                   t3 = xercesc::XMLString::transcode("Start")) == 0)
                                        {
                                            ...
                                            {
                                                xercesc::DOMCharacterData *startCharacterData =
                                                    dynamic_cast<xercesc::DOMCharacterData *>(StartChildrenList->item(startChildIt));
                                                if (startCharacterData)
                                                {
                                                    xercesc::BaseRefVectorOf<XMLCh> *stringVector =
                                                        xercesc::XMLString::tokenizeString(startCharacterData->getData());
                                                    double x = atof(cs = xercesc::XMLString::transcode(stringVector->elementAt(1)));
                                                    xercesc::XMLString::release(&cs);
                                                    double y = atof(cs = xercesc::XMLString::transcode(stringVector->elementAt(0)));
                                                    xercesc::XMLString::release(&cs);
                                    ...
                                    start += length;
                                                                            ...
                                                                            t3 = xercesc::XMLString::transcode("Spiral")) == 0)
                                {
                                    double length = atof(cs = xercesc::XMLString::transcode(
                                                             coordGeomChildElement->getAttribute(t12 = xercesc::XMLString::transcode("length"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double radiusStart = atof(cs = xercesc::XMLString::transcode(coordGeomChildElement->getAttribute(
                                                                  t12 = xercesc::XMLString::transcode("radiusStart"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double radiusEnd = atof(cs = xercesc::XMLString::transcode(coordGeomChildElement->getAttribute(
                                                                t12 = xercesc::XMLString::transcode("radiusEnd"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    std::string rot(cs = xercesc::XMLString::transcode(
                                                        coordGeomChildElement->getAttribute(t12 = xercesc::XMLString::transcode("rot"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    ...
                                    {
                                        xercesc::DOMElement *spiralChildElement =
                                            dynamic_cast<xercesc::DOMElement *>(SpiralChildrenList->item(spiralChildIt));
                                        if (spiralChildElement &&
                                            xercesc::XMLString::compareIString(spiralChildElement->getTagName(),
                                                                               t4 = xercesc::XMLString::transcode("Start")) == 0)
                                        {
                                            ...
                                            for (unsigned int startChildIt = 0; startChildIt < StartChildrenList->getLength(); ++startChildIt)
                                            {
                                                ...
                                                if (startCharacterData)
                                                {
                                                    ...
                                                    road->addPlanViewGeometrySpiral(start,
                                                                                    length,
                                                                                    x,
                                                                                    y,
                                                                                    2 * M_PI / 360.0 * dir,
                                                                                    curvSign / radiusStart,
                                                                                    curvSign / radiusEnd);
                                    ...
                                    start += length;
                                                                            ...
                                                                            t4 = xercesc::XMLString::transcode("Curve")) == 0)
                                {
                                    double length = atof(cs = xercesc::XMLString::transcode(
                                                             coordGeomChildElement->getAttribute(t12 = xercesc::XMLString::transcode("length"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double dirStart = atof(cs = xercesc::XMLString::transcode(
                                                               coordGeomChildElement->getAttribute(t12 = xercesc::XMLString::transcode("dirStart"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double dirEnd = atof(cs = xercesc::XMLString::transcode(
                                                             coordGeomChildElement->getAttribute(t12 = xercesc::XMLString::transcode("dirEnd"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    double radius = atof(cs = xercesc::XMLString::transcode(
                                                             coordGeomChildElement->getAttribute(t12 = xercesc::XMLString::transcode("radius"))));
                                    xercesc::XMLString::release(&t12);
                                    xercesc::XMLString::release(&cs);
                                    std::string rot(cs = xercesc::XMLString::transcode(
                                                        coordGeomChildElement->getAttribute(t12 = xercesc::XMLString::transcode("rot"))));
                                    ...
                                    {
                                        xercesc::DOMElement *curveChildElement =
                                            dynamic_cast<xercesc::DOMElement *>(CurveChildrenList->item(curveChildIt));
                                        if (curveChildElement && xercesc::XMLString::compareIString(curveChildElement->getTagName(),
                                                                                                    t5 = xercesc::XMLString::transcode("Start")) == 0)
                                        {
                        ...
                        xercesc::DOMNodeList *ProfileList = alignmentElement->getElementsByTagName(t2 = xercesc::XMLString::transcode("Profile"));
                        xercesc::XMLString::release(&t2);
                        for (unsigned int profileIt = 0; profileIt < ProfileList->getLength(); ++profileIt)
                        {
                            ...
                            if (profileElement)
                            {
                                xercesc::DOMNodeList *ProfAlignList =
                                    profileElement->getElementsByTagName(t3 = xercesc::XMLString::transcode("ProfAlign"));
                                xercesc::XMLString::release(&t3);
                                for (unsigned int profAlignIt = 0; profAlignIt < ProfAlignList->getLength(); ++profAlignIt)
                                {
                                    ...
                                    if (profAlignElement)
                                    {
                                        ...
                                        for (unsigned int profAlignChildIt = 0; profAlignChildIt < ProfAlignChildrenList->getLength();
                                             ++profAlignChildIt)
                                        {
                                            xercesc::DOMElement *profAlignChildElement =
                                                dynamic_cast<xercesc::DOMElement *>(ProfAlignChildrenList->item(profAlignChildIt));
                                            if (!profAlignChildElement)
                                            {
                                            }
                                            else if (xercesc::XMLString::compareIString(profAlignChildElement->getTagName(),
                                                                                        t2 = xercesc::XMLString::transcode("PVI")) == 0)
                                            {
                                                lVec.push_back(0.0);
                                                ...
                                                {
                                                    xercesc::DOMCharacterData *pviCharacterData =
                                                        dynamic_cast<xercesc::DOMCharacterData *>(PviChildrenList->item(pviChildIt));
                                                    if (pviCharacterData)
                                                    {
                                                        xercesc::BaseRefVectorOf<XMLCh> *stringVector =
                                                            xercesc::XMLString::tokenizeString(pviCharacterData->getData());
                                                        double h = atof(cs = xercesc::XMLString::transcode(stringVector->elementAt(1)));
                                                        xercesc::XMLString::release(&cs);
                                                        double s = atof(cs = xercesc::XMLString::transcode(stringVector->elementAt(0)));
                                                        xercesc::XMLString::release(&cs);
                                                        hVec.push_back(h);
                                                        sVec.push_back(s);
                                                        ...
                                                        break;
                                                                                        ...
                                                                                        t3 = xercesc::XMLString::transcode("ParaCurve")) == 0)
                                            {
                                                double length = atof(cs = xercesc::XMLString::transcode(profAlignChildElement->getAttribute(
                                                                         t12 = xercesc::XMLString::transcode("length"))));
                                                xercesc::XMLString::release(&t12);
                                                xercesc::XMLString::release(&cs);
                                                ...
                                                for (unsigned int paraCurveChildIt = 0; paraCurveChildIt < ParaCurveChildrenList->getLength();
                                                     ++paraCurveChildIt)
                                                {
                                                    xercesc::DOMCharacterData *paraCurveCharacterData =
                                                        dynamic_cast<xercesc::DOMCharacterData *>(ParaCurveChildrenList->item(paraCurveChildIt));
                                                    if (paraCurveCharacterData)
                                                    {
                                                        xercesc::BaseRefVectorOf<XMLCh> *stringVector =
                                                            xercesc::XMLString::tokenizeString(paraCurveCharacterData->getData());
                                                        double h = atof(cs = xercesc::XMLString::transcode(stringVector->elementAt(1)));
                                                        xercesc::XMLString::release(&cs);
                                                        double s = atof(cs = xercesc::XMLString::transcode(stringVector->elementAt(0)));
                                                        xercesc::XMLString::release(&cs);
                    ...
                    xercesc::XMLString::release(&align);
                    xercesc::XMLString::release(&t1);
                }
            }
        }
...
void RoadSystem::parseIntermapRoad(const std::string &filename, const std::string &projFromString, const std::string &projToString)
{
    ...
    //                     endGradient = (ZVector[i + 2] - ZVector[i]) / sqrt(pow(XVector[i + 2] - XVector[i], 2) + pow(YVector[i + 2] - YVector[i],
    //                     2)); startGradient =
    //                         2.0 * (ZVector[i + 1] - ZVector[i]) / sqrt(pow(XVector[i + 1] - XVector[i], 2) + pow(YVector[i + 1] - YVector[i], 2)) -
    //                         endGradient;
    //                 }
    ...
    //                     startGradient = (ZVector[i + 1] - ZVector[i - 1]) /
    //                                     sqrt(pow(XVector[i + 1] - XVector[i - 1], 2) + pow(YVector[i + 1] - YVector[i - 1], 2));
    //                     endGradient =
    //                         2.0 * (ZVector[i + 1] - ZVector[i]) / sqrt(pow(XVector[i + 1] - XVector[i], 2) + pow(YVector[i + 1] - YVector[i], 2)) -
    //                         startGradient;
    //                 }
    ...
    //                 /*if(length<0) {
    //              std::cout << "Road: " << road->getId() << ", length: " << length << ", endU: " << endU << ", endX: " << endX << ", endY: " << endY
    //              <<
    //              ", startHdg: " << startHdg << ", endHdg: " << endHdg << ", endSlope: " << endSlope << ", size: " << XVector.size() << std::endl;
    //              }*/
    //                 /* lines */
    ...
    //                     double segmentlength   = sqrt(pow(XVector[startIndex] - XVector[startIndex + numLineSegments], 2) +
    //                                                 pow(YVector[startIndex] - YVector[startIndex + numLineSegments], 2));
    //                     road->addPlanViewGeometryLine(start,
    //                                                   length,
    //                                                   XVector[startIndex],
    //                                                   YVector[startIndex],
    //                                                   atan2(YVector[endIndex] - YVector[startIndex], XVector[endIndex] - XVector[startIndex]));
    //                     start += segmentlength;
...
Vector2D RoadSystem::searchPosition(const Vector3D &worldPos, Road *&road, double &u)
{
    ...
    else
    {
        ...
        for (unsigned int roadIt = 0; roadIt < roadVector.size(); ++roadIt)
        {
            ...
            // std::cout << "BB: " << roadBox.xMin() << ", " << roadBox.yMin() << ", " << roadBox.zMin() << " - " << roadBox.xMax() << ", " <<
            // roadBox.yMax() << ", " << roadBox.zMax() << std::endl;
        }
        ...
        if (road->isJunctionPath())
        {
            ...
            for (std::map<Road *, PathConnectionSet>::const_iterator connSetIt = connSetMap.begin(); connSetIt != connSetMap.end(); ++connSetIt)
            {
                for (PathConnectionSet::const_iterator connIt = connSetIt->second.begin(); connIt != connSetIt->second.end(); ++connIt)
                {
                    ...
                    {
                        // std::cout << "On junction, changing position from path " << road->getId() << " to path " <<
                        // (*connIt)->getConnectingPath()->getId() << ": (" << pos.u() << ", " << pos.v() << ") -> (" << newPos.u() << ", " <<
                        // newPos.v() << ")" << std::endl;
    ...
    for (std::vector<Road *>::iterator outerRoadIt = roadVector.begin(); outerRoadIt != outerRoadEndIt; ++outerRoadIt)
    {
        for (std::vector<Road *>::iterator innerRoadIt = outerRoadIt + 1; innerRoadIt != roadVector.end(); ++innerRoadIt)
        {
            if ((*outerRoadIt)->getJunction() != (*innerRoadIt)->getJunction())
                continue;
            std::cout << "RoadSystem::analyzeForCrossingJunctionPaths(): Road " << (*outerRoadIt)->getId() << " in same junction as road "
                      << (*innerRoadIt)->getId() << std::endl;
...
void RoadSystem::scanStreets()
{
    ...
    for (int count = 0; count < numRoads; count++)
    {
        ...
        while (length < current_road->getLength())
        {
            ...
            else
            {
                ...
                {
                    x_min = x;
                    // std::cout << "..x_min........Road: " << count << " s-Pos: " << length << " x-Pos: " << x << " y-Pos: " << y << " ||| x_min: "
                    // << x_min << " x_max: " << x_max << " | y_min: " << y_min << " y_max: " << y_max << std::endl;
                }
                else if (x > x_max)
                {
                    x_max = x;
    ...
    {  // Alle StraÃn durchlaufen
        ...
        {  // s-Koordinate der jeweiligen StraÃ abfahren
            ...
            if (check_position(current_tile[0], current_tile[1]))
            {
                ...
                for (it = ((rls_vector[current_tile[0]])[current_tile[1]]).begin(); it != ((rls_vector[current_tile[0]])[current_tile[1]]).end();
                     ++it)
                {
                    if (strcmp((((*it)->getRoad())->getId()).c_str(), (current_road->getId()).c_str()) == 0)
                    {
                        (*it)->check_s(length);  // falls die StraÃ vorhanden ist, soll s überprüft werden um s_min und s_max innerhalb der aktuellen
                                                 // Kachel zu bestimmen
                        inList = true;
                        break;
                    }
     ...
     *                                                                                                 if (((rls_vector.at(j)).at(i)).size() == 0)
     * std::cout << "-"; else std::cout << ((rls_vector.at(j)).at(i)).size();
     *                                                                                                                                                         }
     *                                                                                                                                                                                 std::cout
     * << std::endl;
     *                                                                                                                                                                                                 }
     *                                                                                                                                                                                                         }
     *                                                                                                                                                                                                                 std::cout
     * << "... delta x: " << delta_x << " | delta y: " << delta_y << std::endl << " _tiles_x " << _tiles_x  << " _tiles_y " << _tiles_y << std::endl;
     *                                                                                                                                                                                                                 */
}
...
osg::ref_ptr<osg::Group> RoadSystem::initOsg(osg::Matrixd geoCentricMapOrigin)
{
    if (roadSystemRoot.get() == nullptr)
        roadSystemRoot = new osg::Group;
    osg::MatrixTransform* positionedRoot = new osg::MatrixTransform(geoCentricMapOrigin);
    roadSystemRoot->addChild(positionedRoot);
    for (auto &r : roadVector)
    {
        osg::Group *g = r->getRoadGroup(false,true);
        positionedRoot->addChild(g);
    }
    return roadSystemRoot;
}

static long long nextRoadId = 0;
const std::map<long long, osg::ref_ptr<osg::Vec3dArray>> &RoadSystem::initOsgOutlines()
{
    for (auto &r : roadVector)
    {
        // this mechanisms makes it hard / impossible to determine the road an outline belongs to ... not nice!
        auto vecOutlines = r->getRoadOutline();
        for(size_t i=0;i<vecOutlines.size();++i)
            outlines[nextRoadId++] = vecOutlines[i];
    }
    return outlines;
}
